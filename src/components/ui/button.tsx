  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        accent:
          "bg-accent text-accent-foreground shadow-button hover:bg-accent/90",
        industrial:
          "bg-gradient-to-b from-primary to-primary/90 text-primary-foreground shadow-tool border border-primary/20 hover:from-primary/90 hover:to-primary/80",
        tool:
          "bg-card text-foreground shadow-card border-2 border-border hover:border-accent hover:shadow-tool",
        warning:
